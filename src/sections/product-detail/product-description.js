                ...
                <div class="row no-gutters">
                  <div class="col mb-6 mb-md-0">
                    ...
                    <div class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                      ...
                      />
                      <label
                        class="form-check-label mb-1 text-blue"
                        htmlFor="inlineCheckbox2"
                      >
                        <span class="text-decoration-on cursor-pointer-on">
                          Universal Headphones Case in Black
                        </span>{" "}
                        - <span class="text-red font-size-16">$159.00</span>
                      </label>
                    </div>
                    <div class="form-check pl-4 pl-md-0 ml-md-4 mb-2 pb-2 pb-md-0 mb-md-0 border-bottom border-md-bottom-0">
                      <input
                  ...
                  <div class="col-md-auto">
                    <div class="mr-xl-15">
                      <div class="mb-3">
                        <div class="text-red font-size-26 text-lh-1dot2">
                          $244.00
                        </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                    <Image
                      height={600}
                      width={600}
                      class="img-fluid mr-n4 mr-md-n10 mr-xl-n15"
                      src="/img/1024X1024/img1.jpg"
                      alt="Image Description"
                    />
                  </div>
                  <div class="col-md-6 text-left">
                    <Image
                      height={600}
                      width={600}
                      class="img-fluid ml-n4 ml-md-n10 ml-xl-n15"
                      src="/img/1024X1024/img2.jpg"
                      alt="Image Description"
                    />
                  </div>
                ...
                <div class="row mb-8">
                  <div class="col-md-6">
                    ...
                    <ul class="list-unstyled">
                      <li class="py-1">
                        <a
                          class="row align-items-center mx-gutters-2 font-size-1"
                          href="javascript:;"
                        >
                    ...
                    <form class="js-validate">
                      <div class="row align-items-center mb-4">
                        <div class="col-md-4 col-lg-3">
                          <label htmlFor="rating" class="form-label mb-0">
                            Your Review
                          </label>
                        </div>
